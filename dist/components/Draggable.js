        ...
        requestAnimationFrame(() => {
            requestAnimationFrame(() => {
                ...
                if (containerElement) {
                    ...
                    const newScaleFactor = currentZoomFactor === scaleFactors[4]
                        ? scaleFactors[1]
                        : scaleFactors[4];
                    ...
                    scrollContainer.scrollTo(Math.max(0, newScrollX), Math.max(0, newScrollY), "auto" // Use 'auto' for instant, non-animated scroll
                    );
                }
            });
        });
