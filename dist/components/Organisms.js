...
import { RotateCcwSquare, RotateCwSquare, RefreshCw, FlipHorizontal2, FlipVertical2, ArrowRightToLine, ArrowLeftToLine, Download, BookOpen, Image, Pin, } from "lucide-react";
...
export function DefaultHeader() {
    ...
    defaultActions.push(_jsx(ActionButtonAtom, { tooltip: "Reset image position", disabled: !imageLoaded, onClick: () => lightboxState.resetMaipulationState(), icon: _jsx(RefreshCw, { color: "white" }) }, "reset-image"));
