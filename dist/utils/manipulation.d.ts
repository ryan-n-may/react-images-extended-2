...
export declare function getImgWidthHeight(imgWidth: number, imgHeight: number, containerWidthRef: MutableRefObject<number>, containerHeightRef: MutableRefObject<number>, footerHeightRef: MutableRefObject<number>): [number, number];
...
export declare function handleReset(widthRef: number, heightRef: number, imageWidth: number, imageHeight: number): Partial<ILightboxImageState>;
